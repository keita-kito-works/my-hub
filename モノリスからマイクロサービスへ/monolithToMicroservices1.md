...
* 技術の凝集度（フロント、バック、DB）ではなく、ビジネスの凝集度が高い
* カプセル化されたビジネス機能を1つ以上のネットワークエンドポイントを介して公開するもの
...
* 全体の処理を完了するために、全てのすべてのサービスを起動し連携している状態
* キャッシュの使用等で回避
